...
# 1.1.  Удаление внешних двойных кавычек
# 1.1.  Если "productOfferCfg" = null
# 1.2.      Значение "productOfferCfg" - замена с null на []                                                -> epc_widget_json
# 1.2.  Если "productOfferCfg" != null
# 1.2.      Значение "productOfferCfg" = Значение "productOfferCfg" обернутое []
...
# Объявление констант
PATH_JSON="/home/GD/ruslan.petrov/Документы/Embed_files/Scripts/list-epc-widget.txt"
PATH_RESULT="/home/GD/ruslan.petrov/Документы/Embed_files/KNS-TEMP_VK.html"
...
epc_widget_json="${epc_widget_json:1:-1}"
...
if [$product_offer_cfg == "null"]; then
    echo "product_offer_cfg = null"
